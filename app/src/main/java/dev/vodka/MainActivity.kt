...
class MainActivity : AppCompatActivity() {
  ...
  companion object {
    private val PACKAGE_DIRS = mapOf(
      ...
      "content-avatar.zip" to "content/avatar",
      "content-configs.zip" to "content/configs",
      "content-fonts.zip" to "content/fonts",
      "content-sky.zip" to "content/sky",
      "content-sounds.zip" to "content/sounds",
      "content-textures2.zip" to "content/textures",
      "content-studio_svg_textures.zip" to "content/studio_svg_textures",
      "content-models.zip" to "content/models",
      "content-textures3.zip" to "PlatformContent/pc/textures",
      "content-terrain.zip" to "PlatformContent/pc/terrain",
      "content-platform-fonts.zip" to "PlatformContent/pc/fonts",
      "content-platform-dictionaries.zip" to "PlatformContent/pc/shared_compression_dictionaries",
      "content-qt_translations.zip" to "content/qt_translations",
      "content-api-docs.zip" to "content/api_docs",
      "extracontent-scripts.zip" to "ExtraContent/scripts",
      "extracontent-luapackages.zip" to "ExtraContent/LuaPackages",
      "extracontent-translations.zip" to "ExtraContent/translations",
      "extracontent-models.zip" to "ExtraContent/models",
      "extracontent-textures.zip" to "ExtraContent/textures",
      "studiocontent-models.zip" to "StudioContent/models",
      "studiocontent-textures.zip" to "StudioContent/textures",
      "shaders.zip" to "shaders",
      "ssl.zip" to "ssl",
    )
  }
}
